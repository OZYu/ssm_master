...
<body>
		...
		<table class="table table-bordered table-hover table-striped">
			...
			<c:forEach items="${pb.beanList }" var="m">
				<tr>
					...
					<td>${m.school.name}</td>
					<td><a href="http://localhost/ssm-curd/monster/${m.monsterId }"
						class="deleteId btn btn-danger">删除</a></td>
					<td><a href="http://localhost/ssm-curd/monster/${m.monsterId }" class="btn btn-primary">修改</a></td>
				</tr>
			</c:forEach>
		</table>
		<!-- 准备一个隐藏表单 -->
	...
	<p align="right">
			点击此处---><a href="http://localhost/ssm-curd/addUI" class="btn">添加妖怪</a>
		</p>
</body>
</html>